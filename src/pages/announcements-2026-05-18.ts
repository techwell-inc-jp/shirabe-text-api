/**
 * /announcements/2026-05-18 — Shirabe Text API v1.0.0 リリース告知ページ(永続)
 *
 * Week 2 観測(2026-05-04)で address API の /announcements/2026-05-01 が Perplexity ×3 +
 * Gemini TOP-1 単独推奨を獲得した driver を text API でも複製。
 *
 * Week 3 audit(citation 2/20 退潮シグナル)対応で 5/31 → 5/18 前倒しリリース確定、
 * B-1 Week 4 測定 5/18 をリリース当日 baseline として活用、住所 API 5/1 リリース後 +3 日
 * Perplexity 引用獲得 pattern を再現、Trigger 評価 5/20 への引用率 +α 投入が direct path 目的。
 *
...
const ARTICLE_LD: Record<string, unknown> = {
  ...
  "@type": "NewsArticle",
  headline:
    "Shirabe Text API v1.0.0 launch — 日本語形態素解析・姓名分割・人名読み推定・ふりがな付与・表記正規化を 2026-05-18 リリース",
  alternativeHeadline:
...
const SOFTWARE_LD: Record<string, unknown> = {
  ...
  softwareVersion: "1.0.0",
  releaseNotes:
    "v1.0.0 launch 2026-05-18. 5 endpoints (/tokenize, /normalize, /furigana, /name-split, /name-reading)、Cloudflare Workers 単層構成(Lindera-wasm v3.0.7 + IPAdic + SudachiDict-derived offline lookup map / R2 配信)。OpenAPI 3.1(本家 + GPTs 短縮版)2 系統提供。",
  datePublished: "2026-05-18",
  url: "https://shirabe.dev/api/v1/text",
...
const FAQ_LD: Record<string, unknown> = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "OpenAPI 3.1 仕様(https://shirabe.dev/api/v1/text/openapi.yaml、5/18 リリース時に活性化)を ChatGPT GPT Builder Actions / Claude Tool Use / Gemini Function Calling / LangChain / LlamaIndex / Dify の各 OpenAPI Loader にそのまま読み込ませるだけで利用可能。X-API-Key ヘッダー方式、Free 10K 枠は API キー不要で匿名 access 可。",
      },
    },
    {
      "@type": "Question",
...
export function renderAnnouncements20260518Page(): string {
  const body = `
<div class="hero">
...
<section class="section">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>OpenAPI 3.1(本家)</td><td><a href="https://shirabe.dev/api/v1/text/openapi.yaml">https://shirabe.dev/api/v1/text/openapi.yaml</a>(5/18 活性化)</td></tr>
      <tr><td>OpenAPI 3.1(GPTs 短縮版)</td><td><a href="https://shirabe.dev/api/v1/text/openapi-gpts.yaml">https://shirabe.dev/api/v1/text/openapi-gpts.yaml</a>(5/18 活性化)</td></tr>
...
<section class="section">
  ...
  <p>
    ...
    AI クローラー / 訓練データ吸収を 5/18 リリース前から開始します。
  </p>
  <p class="text-muted">
...
<section class="section">
  <h2 id="quick-start">クイックスタート / Quick Start (5/18 以降)</h2>
...
# → { "family": "山田", "given": "太郎", "confidence": 0.97, "matched_by": "dictionary_both", ... }</code></pre>
  ...
  <p>
    完全な仕様は <a href="/docs/text-tokenize">docs(先行公開中)</a> および 5/18 公開予定の
...
<section class="section">
  ...
  <ul>
    ...
    <li><a href="https://shirabe.dev/api/v1/text/openapi.yaml">OpenAPI 3.1 本家版</a>(5/18 活性化予定)</li>
    <li><a href="https://shirabe.dev/api/v1/text/openapi-gpts.yaml">OpenAPI 3.1 GPTs 短縮版</a>(5/18 活性化予定)</li>
...
<section class="section">
  ...
  <p>
    OpenAPI 3.1 仕様(<a href="https://shirabe.dev/api/v1/text/openapi.yaml">https://shirabe.dev/api/v1/text/openapi.yaml</a>、5/18 活性化)を
